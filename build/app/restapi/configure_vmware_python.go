...
//go:generate swagger generate server --target ../../app --name VmwarePython --spec ../../../swagger.yaml --template-dir /Users/wilhelmwonigkeit/Documents/GitHub/direktiv-apps/vmware-python/build/templates --principal interface{}

func configureFlags(api *operations.VmwarePythonAPI) {
...
func configureAPI(api *operations.VmwarePythonAPI) http.Handler {
